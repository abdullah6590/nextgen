...
export const FeaturedProduct = ({
  ...
  return (
    <div className="col-span-12 md:col-span-6 lg:col-span-3 row-span-1 bg-surface-container-low rounded-lg overflow-hidden border border-outline-variant/10 hover-lift group relative">
      ...
      <div className="p-6 flex flex-col h-[calc(100%-12rem)] justify-between">
        ...
        {isQuickPurchase ? (
          ...
          <button className="relative z-20 w-full bg-gradient-to-r from-primary to-primary-container text-on-primary py-3 rounded-full text-xs font-bold uppercase tracking-widest group-hover:shadow-[0_0_15px_rgba(76,215,246,0.4)] transition-all">Acquire Asset</button>
        )}
      </div>
    </div>
  );
